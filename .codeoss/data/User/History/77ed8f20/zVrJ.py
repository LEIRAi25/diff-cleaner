...
FIRESTORE_DATABASE_ID = env.get("FIRESTORE_DATABASE_ID", "(default)")
...
def is_new_hash(hash_str: str) -> bool:
    ...
    try:
        ...
        return False
i had already added the variable 
...
def main():
    ...
    try:
        ...
        logging.critical("Please check the following:")
        logging.critical("  1. A Firestore database exists in the project.")
        logging.critical("  2. It is in 'Native Mode', not 'Datastore Mode'.")
        logging.critical("  3. If using a non-default database, ensure the 'FIRESTORE_DATABASE_ID' environment variable is set correctly.")
        sys.exit(1)
